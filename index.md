...
### Das Reich Eternity
Eternity ist ein riesiges VRMMO (Virtuelle Realität Massively Multiplayer Online), in dem die gesamte Welt als **"Scheinrealität"** existiert.

**Wichtige Merkmale:**
- Virtuelle Realitätswelt mit spielinternen Regeln
- Level-Up-System mit Attributen und Fähigkeiten
...
### Drachen-Rassen
Legendäre Rasse, die Spieler durch Quest-Belohnungen erlangen können. Ben erhält die Wahl zwischen legendärer Rasse (Drache) oder legendärer Klasse (Erzmagier).

### Konzerne (Band 2)
- **Nexagen, OmniCorp, Meridian-Allianz** – Die drei Großkonzerne, die im Jahr 2070 die Welt beherrschen.
...
- **2023 (Januar):** Band 1 veröffentlicht auf Amazon.de
